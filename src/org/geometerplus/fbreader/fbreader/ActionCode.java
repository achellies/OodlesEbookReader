...
public interface ActionCode {
	...
	String SWITCH_TO_SEPIA_PROFILE="sepia";

	String SHARE_BOOK = "shareBook";
	
	//edited actions
	String OPEN_BOOK = "openBook";
	String TOUCH_ACTIONS = "touchScreen";
	String TOGGLE_BOOKMARK="bookmarkAddDelete";
	String DRAW_POINTER= "selectionPinter";
