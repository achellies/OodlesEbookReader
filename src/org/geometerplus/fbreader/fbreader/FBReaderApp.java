...
public final class FBReaderApp extends ZLApplication {
	...
	public final ZLColorOption ImageViewBackgroundOption =
		new ZLColorOption("Colors", "ImageViewBackground", new ZLColor(0, 0, 0));
	...
	public final ZLIntegerRangeOption BottomMarginOption;
	{
		...
		final int horMargin = Math.min(dpi / 2, Math.min(x, y) / 10);//(,48) nexus
		...
		TopMarginOption = new ZLIntegerRangeOption("Options", "TopMargin", 0, 100, 40);
		BottomMarginOption = new ZLIntegerRangeOption("Options", "BottomMargin", 0, 100, 40);
	}
	...
	public final ZLIntegerRangeOption FooterHeightOption =
		new ZLIntegerRangeOption("Options", "FooterHeight", 8, 20, 12);
	...
	public final ZLBooleanOption ShowPositionsInCancelMenuOption =
		new ZLBooleanOption("CancelMenu", "positions", false);
	...
	public FBReaderApp() {
		...
		addAction(ActionCode.SWITCH_TO_SEPIA_PROFILE, new SwitchProfileAction(this, ColorProfile.SEPIA));
